  ...
  <div id="About" className="container">
    ...
    <div className="mt-20 flex flex-col gap-8">
      <div className="grid grid-cols-1 gap-8 md:grid-cols-5 lg:grid-cols-3">
        <Card className= "h-[320px] md:col-span-2 lg:col-span-1 animationScroll" 
        ...
        <Card className="h-[320px] md:col-span-3 lg:col-span-2 animationScroll"
        style={{ animationDuration: '5s', animationTimingFunction: 'linear' }}>
        <CardHearder 
          title={"My Toolbox"} 
    ...
    <div className="grid grid-cols-1 gap-8 md:grid-cols-5 lg:grid-cols-3">       
      <Card className="h-[320px] p-0 flex flex-col md:col-span-3 lg:col-span-2 animationScroll
      " style={{ animationDuration: '5s', animationTimingFunction: 'linear' }}>       
        <CardHearder 
      ...
      <Card className="h-[320px] p-0 relative md:col-span-2 lg:col-span-1 animationScroll"
      style={{ animationDuration: '5s', animationTimingFunction: 'linear' }}>
        ...
        after:outline-gray-950/30">
          ...
          bg-gradient-to-r from-emerald-300 to-sky-400 -z-20 animate-ping [animation-duration:2s]"></div>
          <div className="absolute inset-0 rounded-full 
          bg-gradient-to-r from-emerald-300 to-sky-400 -z-10"></div>
          <Image src={mapMemoji} alt="smile memoji" 
